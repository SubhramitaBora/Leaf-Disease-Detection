...
BEST_MODEL_PATH = os.path.join(OUTPUT_DIR, "new_multiclass_resnet50_best.keras")
FINAL_MODEL_PATH = os.path.join(OUTPUT_DIR, "new_multiclass_resnet50_final.keras")
CLASS_NAMES_PATH = os.path.join(OUTPUT_DIR, "new_multiclass_class_names.json")
PLOT_PATH = os.path.join(OUTPUT_DIR, "new_multiclass_resnet50_training_plot.png")
...
def plot_training_curves(history_data, output_path, fine_tune_start_epoch):
    ...
    plt.title("ResNet50 Multiclass Accuracy")
    plt.xlabel("Epoch")
    plt.ylabel("Accuracy")
    plt.legend()
    ...
    if fine_tune_start_epoch > 0:
        plt.axvline(fine_tune_start_epoch + 0.5, color="gray", linestyle="--", label="Fine-tuning start")
    plt.title("ResNet50 Multiclass Loss")
    plt.xlabel("Epoch")
    plt.ylabel("Loss")
    plt.legend()
...
# 4. BUILD MODEL
# ==========================================
print("\nBuilding ResNet50 multiclass model...")
